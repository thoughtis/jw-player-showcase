...
function enqueue_assets() {
	...
	wp_enqueue_script( 'jw-player-showcase', JWSHOWCASE_PLUGIN_URL . 'public/js/build.js', array(), ( WP_DEBUG ? mt_rand() : '1.0.0' ), true );

	wp_enqueue_style( 'jw-player-showcase', JWSHOWCASE_PLUGIN_URL . 'public/css/app.css', array(), ( WP_DEBUG ? mt_rand() : '1.0.0' ), 'screen' );
